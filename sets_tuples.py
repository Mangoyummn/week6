...
# # instead you convert the set to a list amd acess elements by index
# list=list(set1)
# #We use sets when we want to store unique elements
# #We use sets when we dont care about the order of the elements
# #and do not want the elements to be changed

# # add elements to a set
# print(set1.add(6)) #Output:{1.2.3.4.5.)
...
# print(sample_list_of_dicts["dicts"][2]["name"]) #Output:charalie
...
print(info["team"]["coach"]['age'])#Ouput:45
...
print(company["department"]["Hr"]["budget"]+["Engineering"]["budget"]) 
